...
(l'exemple que j'ai donné provient d'un cours quee j'ai pris sur internet) l'algorithme est un peu compliqué pour le coup pour savoir si un point est a l'intérieur de l'enveloppe convexe je vais essayer de le simplifier